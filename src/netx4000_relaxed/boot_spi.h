...
void boot_spi_activate_mmio(const SPI_CFG_T *ptCfg, const NX4000RELAXED_MMIO_CFG_T *ptMmioValues);
void boot_spi_deactivate_mmio(const SPI_CFG_T *ptCfg, const NX4000RELAXED_MMIO_CFG_T *ptMmioValues);
